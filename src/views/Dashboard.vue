        ...
        <v-row>
                ...
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[0].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[0].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
            ...
            <v-col cols="12" md="4">
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[1].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[1].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
            ...
            <v-col cols="12" md="4">
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[2].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == upcomingFixtures[2].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
        ...
        <v-row v-if="recentResults.length > 0">
            <v-col cols="12" md="4">
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[0].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[0].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
            ...
            <v-col cols="12" md="4">
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[1].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[1].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
            ...
            <v-col cols="12" md="4">
                <v-card outlined class="pb-5">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[2].HomeTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
                    ...
                    <v-row>
                        <v-col cols="1" class="text-right">
                            <v-img :src="getImagePath(teams.find(team => team.id == recentResults[2].AwayTeam).Image)" width="30" class="mx-3"></v-img>
                        </v-col>
                        <v-col class="pt-4">
